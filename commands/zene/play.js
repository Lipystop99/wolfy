...
const { YOUTUBE_API_KEY, SOUNDCLOUD_CLIENT_ID, LOCALE, DEFAULT_VOLUME } = require("../../core/musiccore");
...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (mobileScRegex.test(url)) {
      try {
        https.get(url, function (res) {
          if (res.statusCode == "302") {
            ...
            return message.reply("Nem található tartalom ennél a linknél.").catch(console.error);
          }
        });
      } catch (error) {
        console.error(error);
      ...
      return message.reply("Link lekövetése...").catch(console.error);
    }
